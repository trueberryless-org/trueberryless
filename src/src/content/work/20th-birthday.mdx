...
<Image src={barcode} alt="A rocketship in space." />
<Image src={base64code} alt="A rocketship in space." />
<Image src={binarycode} alt="A rocketship in space." />
<Image src={hexcode} alt="A rocketship in space." />
<Image src={morsecode} alt="A rocketship in space." />
<Image src={qrcode} alt="A rocketship in space." />
</div>
