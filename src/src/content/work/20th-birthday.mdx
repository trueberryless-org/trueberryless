...
<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 10px; margin-block: 3rem;">
  <Image src={golden_8} alt="A rocketship in space." />
  <Image src={hans_zimmer} alt="A rocketship in space." />
  <Image src={lifeformed} alt="A rocketship in space." />
  <Image src={celeste} alt="A rocketship in space." />
  <Image src={haven} alt="A rocketship in space." />
  <Image src={annihilate} alt="A rocketship in space." />
  <Image src={taddl} alt="A rocketship in space." />
  <Image src={tenet} alt="A rocketship in space." />
  <Image src={more} alt="A rocketship in space." />
</div>
