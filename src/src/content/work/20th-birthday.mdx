...
<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 10px; margin-block: 3rem;">
  <Image src={golden_8}    alt="Golden 8 playlist cover – a collection of my favorite songs." />
  <Image src={hans_zimmer} alt="Molossus from Batman Begins soundtrack by Hans Zimmer." />
  <Image src={lifeformed}   alt="9-bit Expedition from Fastfall soundtrack by Lifeformed." />
  <Image src={celeste}      alt="Resurrections from Celeste game soundtrack by Lena Raine." />
  <Image src={haven}        alt="22:12 – Until the End of Time by Danger (Haven soundtrack)." />
  <Image src={annihilate}   alt="Annihilate from Across the Spider-Verse soundtrack." />
  <Image src={taddl}        alt="ROTTWEiLER by TJ_beastboy (German rap)." />
  <Image src={tenet}        alt="747 from Tenet soundtrack by Ludwig Göransson." />
  <Image src={more}         alt="MORE by K/DA – K-pop track." />
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 10px; margin-block: 3rem;">
  <Image src={barcode} alt="Barcode representing 20. February." />
  <Image src={base64code} alt="Base64 code encoding 'My birthday is February 20th, 2005'." />
  <Image src={binarycode} alt="Binary code representing 'Today is February 20th, 2025'." />
  <Image src={hexcode} alt="Hex color code representing 'twenty'." />
  <Image src={morsecode} alt="Morse code for '20. FEBRUARY 2005'." />
  <Image src={qrcode} alt="QR code encoding '20.02.2005'." />
</div>
